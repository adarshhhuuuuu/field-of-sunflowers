...
`)}Ac.render(Oc,kc)}yl(),window.addEventListener(`resize`,()=>{kc.aspect=window.innerWidth/window.innerHeight,kc.updateProjectionMatrix(),Ac.setSize(window.innerWidth,window.innerHeight)});