...
`)}Ac.render(Oc,kc)}xl(),window.addEventListener(`resize`,()=>{kc.aspect=window.innerWidth/window.innerHeight,kc.updateProjectionMatrix(),Ac.setSize(window.innerWidth,window.innerHeight)});